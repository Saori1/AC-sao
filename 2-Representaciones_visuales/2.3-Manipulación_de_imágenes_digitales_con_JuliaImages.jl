...
imshow(testimage("chelsea.png"))

# ╔═╡ bc0e18ca-5592-430b-a9b9-af54de6facbe
md"
¿Qué observas en la esquina inferior izquierda de `ImageView` cuando ejecutas la celda anterior y colocas el cursor sobre la imagen? Que son como las coordenadas de la imagen y además nos dice cuanto color tiene el pixel de la imagen. ¿Qué sucede si mueves el cursor de lugar? Dependiendo si lo movemos en horizontal o vertial, estas coordenadas aumentan o decrecen. ¿Qué cosas cambian cuando repetimos el mismo ejercicio con otras imágenes de la lista? Cuanto color tiene el pixel de la imagen.
...
# ╔═╡ fef4bac7-cb47-4558-af4b-e623251be1f5
arte_de_pixeles = [RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0)
RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.6, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.5, 0.0, 0.0) RGB(0.0, 0.0, 0.0)
RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.6, 0.0, 0.0) RGB(0.6, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.5, 0.0, 0.0) RGB(0.5, 0.0, 0.0) RGB(0.0, 0.0, 0.0)
RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.6, 0.0, 0.0) RGB(0.5, 0.0, 0.0) RGB(0.5, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0)
RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0)
RGB(0.0, 0.0, 0.0) RGB(0.0, 0.2, 0.0) RGB(0.0, 0.3, 0.0) RGB(0.0, 0.4, 0.0) RGB(0.0, 0.5, 0.0) RGB(0.0, 0.9, 0.0) RGB(0.0, 0.5, 0.0) RGB(0.0, 0.0, 0.0)
RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.4, 0.0) RGB(0.0, 0.5, 0.0) RGB(0.0, 0.9, 0.0) RGB(0.0, 0.5, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0)
RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.4, 0.0) RGB(0.0, 0.5, 0.0) RGB(0.0, 0.9, 0.0) RGB(0.0, 0.5, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0)
]
